 ...
 * It is a *singleton* class and hence only created and used once (again per
 * scene) It handles object properties like meshes, collisions and gravity It
 * does NOT handle engine properties like ticks or key events
 **/
...
class ECS {
 public:
  ...
  // entity_id createEntity(); // use to create new entities that are part of
  // the engine
