 ...
 * api wrapper. It will be simple and only targets Windows. This decision was made
 * so I can hyper-focus on one platform which means it will be easier to debug
 * any bugs
 *
 */
...
namespace Pequod
{
    ...
    protected:
        ...
        virtual void UpdateOnTick() =0; // Runs every tick (takes priority over frame)
