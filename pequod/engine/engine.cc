...
#include "ecs/ecs.hh"
// [CLAUDE] TODO: Duplicate include — glm/glm.hpp already included two lines
// above
#include <glm/glm.hpp>
...
uint64_t PequodEngine::getTicks() { return this->ticks; }
...
void PequodEngine::SetScene(WorldScene *scene) { currentScene = scene; }

void PequodEngine::sokol_init() {
  currentScene->OnStartInternal();

  currentScene->Initialize();
  // runs only for the initial default scene; every other scene needs to call
  // this themselves
...
bool PequodEngine::isShowDebugStats() { return this->show_debug_stats; }
