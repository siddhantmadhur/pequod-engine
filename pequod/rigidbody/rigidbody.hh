 ...
 * It's purpose is to provide a class for set shapes (such as box2d) so they can
 * be used easily
 *
 * It depends on Jolt for actual callbacks and functioning and does not include
 * any logic
 *
...
// [CLAUDE] TODO: All enum values are = 0; they should be JUST_ACTIVE=0,
// ACTIVE=1, INACTIVE=2
