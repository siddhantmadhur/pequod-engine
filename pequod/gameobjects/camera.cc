...
Camera::Camera(float aspect_ratio) {
  ...
  // [CLAUDE] TODO: View matrix is hardcoded — setPosition() stores
  // cameraPosition but it isn't used here
...
glm::mat4 Camera::getProjection() { return proj; }
...
void Camera::configure2D(float width, float height, float zoom) {
  // TODO: add createOrtho and createPerspective in the engine (maybe to scene?)
  // itself to reduce this code as well
